---
name: customize-site
description: Rebrand a templatized site for a new business — rewrite the content JSON and theme tokens from a brief, without touching any component. Use this after /templatize, or whenever the user wants new copy, a new palette, or the same layout repurposed for a different brand. Also triggers on "rebrand this", "make this for <company>", "change the colors and copy".
short-description: Rebrand a templatized site from a brief — content and theme only, never components
argument-hint: "<brief>"
no-args-hint: "the rebranding brief provided by the user"
user-invocable: true
---
